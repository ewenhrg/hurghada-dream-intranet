 ...
 * @param {{ id?: string, firstName?: string, lastName?: string, phone?: string, email?: string, hotelOption1?: string, hotelOption2?: string, hotelOption3?: string, budget?: string, notes?: string, createdAt?: string }} request
 */
export function generateHotelRequestHTML(request) {
  ...
  const hotels = [request.hotelOption1, request.hotelOption2, request.hotelOption3].filter((h) =>
    String(h || "").trim()
  );
