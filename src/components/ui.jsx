  ...
  <button
    ...
    className={
      ...
      (active
        ...
        : "bg-white/95 text-slate-900 border border-[rgba(148,163,184,0.35)] hover:border-[rgba(79,70,229,0.55)] hover:text-[#4338ca] hover:bg-white hover:shadow-[0_14px_24px_-20px_rgba(79,70,229,0.45)] hover:-translate-y-[1px] active:scale-[0.98]")
    }
  >
    {children}
  </button>
