...
export const TextInput = memo(({ className = "", ...props }) => (
  <input
    {...props}
    className={
      "w-full rounded-xl border border-[rgba(148,163,184,0.35)] bg-[var(--hd-surface-input)] px-4 py-3 text-base text-slate-800 placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-[rgba(79,70,229,0.3)] focus:border-[rgba(79,70,229,0.7)] transition-all duration-200 shadow-[0_16px_35px_-28px_rgba(15,23,42,0.12)] hover:border-[rgba(79,70,229,0.5)] hover:shadow-[0_18px_38px_-28px_rgba(15,23,42,0.15)] focus:shadow-[0_0_0_2px_rgba(79,70,229,0.2),0_18px_36px_-26px_rgba(15,23,42,0.15)] min-h-[44px] touch-manipulation " +
      className
    }
...
export const GhostBtn = memo(({ className = "", size, variant = "neutral", onClick, ...props }) => {
  ...
  return (
    <button
      ...
      {...touchHandlers}
      className={
        "inline-flex items-center justify-center gap-2 rounded-xl font-semibold border shadow-[0_14px_30px_-24px_rgba(15,23,42,0.2)] transition-all duration-200 ease-out hover:-translate-y-[1px] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4f46e5]/20 bg-[var(--hd-surface)] min-h-[44px] min-w-[44px] touch-manipulation hover:shadow-[0_16px_32px_-24px_rgba(15,23,42,0.25)] " +
        sizeClasses +
        " " +
        variantClass +
        " " +
