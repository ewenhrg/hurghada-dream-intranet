...
export const Pill = memo(({ active, children, ...props }) => (
  <button
    ...
    className={
      ...
      (active
        ? "bg-gradient-to-r from-[#4f46e5] via-[#5b3ffd] to-[#0ea5e9] text-white shadow-[0_18px_38px_-18px_rgba(79,70,229,0.75)] hover:shadow-[0_24px_46px_-22px_rgba(79,70,229,0.82)] hover:-translate-y-[2px]"
        : "bg-white/85 text-slate-600 border border-[rgba(148,163,184,0.28)] hover:border-[rgba(79,70,229,0.5)] hover:text-[#4338ca] hover:bg-white hover:shadow-[0_18px_30px_-24px_rgba(79,70,229,0.55)] hover:-translate-y-[2px]")
    }
  >
    {children}
  </button>
...
export const PrimaryBtn = memo(({ className = "", disabled, variant = "primary", ...props }) => {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={
        "inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold text-white transition-all duration-300 ease-out hover:-translate-y-[2px] active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-offset-2 " +
...
export const GhostBtn = memo(({ className = "", size, variant = "neutral", ...props }) => {
  ...
  return (
    <button
      {...props}
      className={
        "inline-flex items-center justify-center gap-2 rounded-xl font-semibold shadow-[0_14px_30px_-24px_rgba(15,23,42,0.4)] transition-all duration-300 ease-out hover:-translate-y-[2px] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4f46e5]/20 bg-white/88 " +
        sizeClasses +
        " " +
        variantClass +
        " " +
