  ...
  <button
    ...
    className={
      ...
      (active
        ...
        : "bg-white/95 text-slate-800 border border-[rgba(148,163,184,0.35)] hover:border-[rgba(79,70,229,0.55)] hover:text-[#4338ca] hover:bg-white hover:shadow-[0_14px_24px_-20px_rgba(79,70,229,0.45)] hover:-translate-y-[1px] active:scale-[0.98]")
    }
  >
    {children}
  </button>
...
export const GhostBtn = memo(({ className = "", size, variant = "neutral", ...props }) => {
  ...
  return (
    <button
      {...props}
      className={
        "inline-flex items-center justify-center gap-2 rounded-xl font-semibold shadow-[0_14px_30px_-24px_rgba(15,23,42,0.4)] transition-transform duration-200 ease-out hover:-translate-y-[1px] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4f46e5]/20 bg-white/90 min-h-[44px] min-w-[44px] hover:shadow-[0_16px_32px_-24px_rgba(15,23,42,0.45)] " +
        sizeClasses +
        " " +
        variantClass +
        " " +
